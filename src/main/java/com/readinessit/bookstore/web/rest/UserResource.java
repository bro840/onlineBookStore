...
import com.readinessit.bookstore.web.rest.errors.EmailAlreadyUsedException;
import com.readinessit.bookstore.web.rest.errors.LoginAlreadyUsedException;
import com.readinessit.bookstore.web.rest.util.HeaderUtil;
import com.readinessit.bookstore.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable) {
        ...
        List<Basket> bs = basketRepository.findAll();
