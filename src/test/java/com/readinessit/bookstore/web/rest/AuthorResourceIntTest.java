...
import com.readinessit.bookstore.domain.enumeration.Country;
/**
...
public class AuthorResourceIntTest {
    ...
    private static final Country DEFAULT_COUNTRY = Country.Portugual;
    private static final Country UPDATED_COUNTRY = Country.Spain;
